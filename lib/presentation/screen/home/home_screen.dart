...
import 'package:mvp_app/presentation/screen/task/task_details.dart';
...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
            ...
            Column(
              ...
              children: [
                ...
                TextWidgets.subHeading(
                    text: "Let's Start your task", fontSize: 16),
              ],
            ),
            const Spacer(),
            ...
            CommonIconButton(
              onPress: () {
                Navigator.push(context,
                    CustomPageRoute.routeFromRight(const NotificationPage()));
              },
  ...
  TabBar tabBarWidget(double size) {
    return TabBar(
      ...
      indicator: UnderlineTabIndicator(
          ...
          insets: EdgeInsets.symmetric(horizontal: size / 3)),
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Common.gHeight(15),
            itemWidget(
                icon: Icons.pause, isHistory: false, date: "Today, 10.00 am"),
          ],
        ),
      ),
    );
  ...
  Widget itemWidget(
      {required IconData icon, required bool isHistory, required String date}) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          CustomPageRoute.routeFromLeft(
            TaskDetailsPage(
              isApproved: isHistory,
            ),
          ),
        );
      },
              ...
              Row(
                children: [
                  Column(
                    ...
                    children: [
                      TextWidgets.subHeading(
                          text: "Design Task management App", fontSize: 14),
                      Common.gHeight(5),
